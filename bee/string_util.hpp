...
std::vector<std::string> split_space(
  std::string_view str, const int max_parts = std::numeric_limits<int>::max());
...
std::string right_pad_string(std::string_view str, size_t length);
...
std::string find_and_replace_all(
  std::string_view str, std::string_view needle, std::string_view rep);

// [trim] removes leading and trailing spaces
std::string trim_spaces(std::string_view str);

bool contains_string(std::string_view str, std::string_view needle);
